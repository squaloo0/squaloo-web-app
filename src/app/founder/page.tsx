...
export const metadata = {
  ...
  description:
    "Technical founder and systems architect building Squaloo — sovereign, offline-first AI, bootstrapped from the ground up.",
};
...
const tracks = [
  ...
  },
  {
    ...
    org: "The QR Matrix",
    description:
      "Built a Version 2 QR code from first principles using a custom go board as the physical matrix. Full implementation of Reed-Solomon error correction and mask pattern encoding — no libraries, no shortcuts.",
    href: "/marshal-qr",
    external: false,
  ...
  },
  {
    ...
    org: "Pacific Life",
    description:
      "Architected and deployed the Customer Acquisition Loop (CAL) — end-to-end automation of web data integration and social media lead capture across an enterprise MarTech stack.",
    href: null,
    external: false,
      ...
      <div className="max-w-5xl mx-auto px-8 pt-32 pb-24">
        ...
        <section className="mb-32">
          ...
          <p className="text-neutral-400 text-base leading-relaxed max-w-2xl mb-12">
            ...
            measured and offline. I&apos;m an MS candidate at USC&apos;s Iovine and Young Academy,
            currently assembling Squaloo&apos;s founding team and first design partners.
          </p>
